...
func GetAllScanCenterController() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		RadiologistData := service.GetAllScanCenterService(dbConn)
...
func GetScanCenterController() gin.HandlerFunc {
	return func(c *gin.Context) {
		idValue, idExists := c.Get("id")
		roleIdValue, roleIdExists := c.Get("roleId")
		...
		RadiologistData := service.GetScanCenterService(dbConn, *data, int(idValue.(float64)))
