...
func GetAllManagerDataController() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		RadiologistData := service.GetAllManagerDataService(dbConn)
...
func GetManagerDataController() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		RadiologistData := service.GetManagerDataService(dbConn, *data, int(idValue.(float64)))
