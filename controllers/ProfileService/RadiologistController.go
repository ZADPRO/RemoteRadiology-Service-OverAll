...
func GetAllRadiologistDataController() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		RadiologistData := service.GetAllRadiologistDataService(dbConn)
...
func GetRadiologistDataController() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		RadiologistData := service.GetRadiologistDataService(dbConn, *data, int(idValue.(float64)))
