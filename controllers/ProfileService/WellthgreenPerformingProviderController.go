...
func GetAllPerformingProviderDataController() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		RadiologistData := service.GetAllPerformingProviderDataService(dbConn)
...
func GetPerformingProviderDataController() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		data, ok := helper.RequestHandler[model.GetRadiologistreq](c)
		if !ok {
			return
		}
		...
		RadiologistData := service.GetPerformingProviderDataService(dbConn, *data, int(idValue.(float64)))
