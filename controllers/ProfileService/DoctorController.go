...
func GetAllDoctorDataController() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		DoctorData := service.GetAllDoctorDataService(dbConn, *data)
...
func GetDoctorDataController() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		RadiologistData := service.GetDoctorDataService(dbConn, *data, int(idValue.(float64)))
