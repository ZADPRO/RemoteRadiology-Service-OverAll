...
func GetAllReceptionistDataController() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		ReceptionistData := service.GetAllReceptionistDataService(dbConn, *data)
...
func GetOneReceptionistDataController() gin.HandlerFunc {
	return func(c *gin.Context) {
		idValue, idExists := c.Get("id")
		roleIdValue, roleIdExists := c.Get("roleId")
		...
		ReceptionistData := service.GetOneReceptionistDataService(dbConn, *data, int(idValue.(float64)))
